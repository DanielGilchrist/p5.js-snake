...
export const facingAfter = (queue: Queue, facing: Geometry.Direction): Geometry.Direction =>
...
export const accept = (
  ...
  const from = facingAfter(queue, facing);
...
export const afterFirst = (queue: Queue): Queue => queue.slice(1);
